...
$id = $_GET['id'];
$article = Corrida::findArticle($id);
...
if(isset($_POST['illustration'])) :
    ...
    Corrida::DestroyImage($oldImage);
    $file = $_FILES['image'];
    $name = time() .'.jpg';
    Corrida::ImageArticle($file, $name);
    Corrida::EditArticle($id,[
        'image' => $name
    ]);
...
<div class="bloc-edit">
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <?= $form->submit('illustration', "Modifier l'image", 'articles.corrida');?>
    </form>
</div>

<div class="return"><a href="index.php?page=articles.corrida"><span class="icon-return"><i class="ion-arrow-left-a"></i></span><span class="text-return">Retour</span></a></div>
...
<div class="bloc-edit">
    <form action="#" method="POST">
        ...
        <?= $form->submit('modifier', 'Modifier', 'articles.corrida') ;?>
    </form>
</div>
