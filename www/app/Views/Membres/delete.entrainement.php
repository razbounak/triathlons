...
if(isset($_POST['delete'])) {
    ...
    Membre::deleteEntrainement($id, $fichier);
    Session::setFlash("L'entrainement a bien été supprimé.", 'success');
    Table::Close();
}
Table::setTitle("Suppression de l'entraiement");
?>

<h2>&Ecirc;tes-vous sûr de vouloir supprimer l'entrainement ?</h2>
