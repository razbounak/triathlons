...
$sponsors = Chalain::AfficheSponsors();
?>
...
<div class="add"><a href="<?= Table::add('sponsor');?>"><span class="icon icon-add"><i class="ion-plus-round"></i></span> <span class="text-add">Ajouter un partenaire</span></a></div>
...
<div class="bloc bloc-actu actualite">
    ...
    foreach ($sponsors as $sponsor): ?>
        <div class="stock bloc-flex">
            <div class="w-20 mobil m100 pl"><img src="http://chalain.triathlons.fr/images/sponsors/<?= $sponsor->image;?>" alt="" width="75"></div><!--
            --><div class="w-30 mobil m50"><?= $sponsor->nom;?></div><!--
