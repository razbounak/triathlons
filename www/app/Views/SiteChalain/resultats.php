...
<div class="add"><a href="<?= Table::add('resultat.chalain');?>"><span class="icon icon-add"><i class="ion-plus-round"></i></span> <span class="text-add">Ajouter un résultat</span></a></div>
...
<div class="bloc bloc-30">
    ...
    foreach ($resultats as $fichier) : ?>
        ...
        --><div class="ac w-15 mobil m50"><a href="https://chalain.triathlons.fr/fichier/<?= $fichier->fichier;?>" target="_blank" title="&#201;diter"><i class="ion-edit cvert"></i></a></div><!--
