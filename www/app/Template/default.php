...
<head>
    ...
    <link rel="stylesheet" href="Template/theme/assets/css/app.css"/>
    <link rel="stylesheet" href="Template/theme/assets/css/ionicons.min.css"/>
</head>
<body>
    ...
    <header class="col1">
        ...
        <nav>
            <ul>
                ...
                ?>><a href="index.php?page=home.chalain"><span class="icone chalain"></span><span class="navtitre">Triathlon Chalain</span></a></li><!--
                --><li <?=
                $name == 'home.corrida' || $name == 'edit.article.corrida' || $name == 'add.article.corrida' || $name == 'delete.article.corrida' || $name == 'articles.corrida' || $name == 'add.sponsor.corrida' || $name == 'corrida.sponsors' || $name == 'edit.course.corrida' || $name == 'edit.programme.corrida' || $name == 'pdf.corrida' || $name == 'edit.inscription.corrida' || $name == 'edit.reglement.corrida' || $name == 'add.resultat.corrida' || $name == 'add.pdf.corrida' || $name == 'corrida.resultats'  ? 'class="active"' : ''
                ?>><a href="index.php?page=home.corrida"><span class="icone corrida"></span><span class="navtitre">Corrida du Parc</span></a></li><!--
                --><li <?=
                $name == 'home.membre' || $name == 'add.document.membre' || $name == 'add.parcours' || $name == 'add.entrainement' || $name == 'documents.membre' || $name == 'edit.document.membre' || $name == 'edit.parcours' || $name == 'edit.programme' || $name == 'home.membre' || $name == 'parcours' || $name == 'programme' || $name == 'entrainements' ? 'class="active"' : ''
                ?>><a href="index.php?page=home.membre"><span class="icone membre"></span><span class="navtitre">Zone Membre</span></a></li><!--
...
<?php endif; ?>
<script src="Template/theme/assets/js/libjs.js" type="text/javascript" language="JavaScript"></script>
<?php
$page = $_GET['page'];
$page = explode('.', $page);
$res = $page[0];
if ($res === 'add' || $res === 'edit') : ?>
    <script src="Template/theme/ckeditor/ckeditor.js"></script>
    <script>
        CKEDITOR.replace('desc');
        CKEDITOR.replace('description_annonce');
    </script>
<?php endif; ?>
<script src="Template/theme/assets/js/jQuery.3.0.js"></script>
<script src="Template/theme/assets/js/AfficheInfo.js"></script>
</body>
</html>